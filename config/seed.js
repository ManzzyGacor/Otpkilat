            ...
            await PaymentMethod.insertMany([
                {
                    ...
                    mode: 'manual',
                    instructions: 'Scan QR di atas dengan aplikasi e-wallet atau mobile banking Anda, lalu tekan "Saya Sudah Bayar". Admin akan mengonfirmasi maksimal 10 menit.',
                    feePercent: 0.7,
                    minAmount: 5000,
                    maxAmount: 1000000,
                    useUniqueCode: true,
                ...
                },
                {
                    ...
                    instructions: 'Transfer tepat sampai 3 digit terakhir agar pembayaran mudah dicocokkan, lalu tekan "Saya Sudah Bayar".',
                    minAmount: 10000,
                    maxAmount: 5000000,
                    useUniqueCode: true,
                    sortOrder: 2,
                ...
                },
                {
                    ...
                    instructions: 'Kirim ke nomor DANA di atas sesuai nominal yang tertera, lalu tekan "Saya Sudah Bayar".',
                    minAmount: 5000,
                    maxAmount: 2000000,
                    useUniqueCode: true,
                    sortOrder: 3,
